...
void update_palette(u8 pal_data, u8 pal) {
    ...
    p_colors[0] = colors_default[pal_data & 0b11]; //bottom 2 bits
    p_colors[1] = colors_default[(pal_data >> 2) & 0b11]; //next 2 bits
    p_colors[2] = colors_default[(pal_data >> 4) & 0b11]; //next 2 bits
    p_colors[3] = colors_default[(pal_data >> 6) & 0b11]; //top 2 bits
}
